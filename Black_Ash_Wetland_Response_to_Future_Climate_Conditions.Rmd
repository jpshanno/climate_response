...
false sense of certainty and dichomtomy to the future climate and wetland
...
probability of observing certain wetland condutions under different vegetation
...
the SWG and LOCA values as climatologies, we randomly sampled 30 sets of 30
...
weather climatologies cluster around the LOCA value as a mean.
...
[@vangrinsven-2017]. Table \@ref(tab:model-metrics) summarizes the wetland
...
(\@ref(tab:model-metrics)). After excluding wetland 119 *R^2* values ranged
from 0.44 0.95.
...
\@ref(tab:pred-probs)). Reported values and significant tests are from a linear
...
\@ref(fig:predicted-probabilities)). Though non-significant these results show
...
show connectivity in July and August under the more senstive climate scenario,
...
overlap with baseline conditions, and the more senstive scenario varied by
...
condtiions, with almost no overlap with current conditions in July, August, and
...
greatest in August under the less senstive climate scenario (Figure
...
**Talk about more senstive connectivity in May and inundation in June as indicators of earlier melt**
