...
independent testing datasets. probability of inundation, connectivity, and 
drawdown and comparing them to observed probabilities of the same conditions,
median absolute error, and *R^2^*.

Median error and *R^2^* results ... Based on these results wetland models and
simulation data from sites 113 and 119 have been excluded from further
analysis due to consistently poor performance in the test data. Based on
knowledge of these sites the authors believe these sites would require a
different hydrologic process model. Site 119 is a closed
basin with no surface outlet and was shown to have different source
water characteristics than other sites [@vangrinsven-2017]. Site 113 has
multiple defined seeps which provide defined surface water inputs to
the site.
