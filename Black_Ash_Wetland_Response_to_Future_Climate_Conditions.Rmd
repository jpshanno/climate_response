...
accuracy of this approach is outside the scope of this study. SectionCASE_STUDYin 
ChapterTRANSDUCER_ERRORSdemonstrates that *ET* estimates derived using this approach 
...
(Figure \@ref(fig:esy-impact)A). Our results show that mid-season periods 
with the highest *PET* are not correctly modeled as having high rates of water 
level decline. This supports the genearl conclusion that the 
impact of *E~Sy~* increases as water levels drawdown and that flood conditions 
approach an *E~Sy~* of 1 (CITATION). These results together with those in Section CASE_STUDY in 
Chapter TRANSDUCER_ERRORS provide empirical evidence that this alternative 
formulation captures the variation of *E~Sy~* with wetlands and can be used in 
scenarios where the rainfall-runoff ratio approach is masked by outside 
influences such as low-frequency hydrologic signals (@zhu-2011).
