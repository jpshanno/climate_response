...
observed water levels greater than or equal to *WL<sub>max</sub>* were assign an
weight equivalent to equal weight. As observed water levels decreased below
...
prediction error to determine model predictive accuracy. In addition to the
...
```{r model-metrics, fig.cap="Wetland model performance metrics. The threes `Outlier Sites` were found to perform much worse than the remaining 10 sites and were excluded from further analysis. Site characteristics suggest that the outlier sites would require new hydrologic models."}
