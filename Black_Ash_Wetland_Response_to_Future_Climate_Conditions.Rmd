...
than regional decline or even slight increases in summer precipitation [LOCA sitation, 
https://climatetoolbox.org/tool/Climate-Mapper, @byun-2018 Figure 7]. Taken 
...
increase 2-8C&deg; [@byun-2018; @hayhoe-2010], and without a commenserate 
...
cause high mortality in all ash native to North America [@herms2014]. As of this
...
wetlands [@vanginsven-2017]. Estimating the behavior of a highly variable
...
concentration pathway (RCP 8.5) [@vanvurren-2011]. The two-scenario ‘bookend’
...
Therefore we fit wetland water levels models to all of the treatment (n = 8; 
girlde and ash cut) study wetlands. Comparisons of the combined and separate 
impacts of EAB and climate change were performed against modeled baselines 
rather than field-study observed conditions. Limiting the number of sites and 
comparing to modeled baselines comparisons of future simulated baselines with each alternative vegetation 
condition was not biased by the number of hydrology of sites within each group. 
Control conditions are represented by the modeled baselines, avoiding the
potential of identifying model artifacts as significant when comparing observed 
and modeled results.
...
#### Check for using 'simulations' instead of 'projections' for GCMS
...
fauna. Although much of the region is expected to have drier summer our localized 
...
would become even more pronounced. Vegetation conditions would still amplify 
or counteract climate impacts, and may become even more important to providing 
...
"3) site conditions following EAB infestation, and 4) site conditions
in a future climate."
