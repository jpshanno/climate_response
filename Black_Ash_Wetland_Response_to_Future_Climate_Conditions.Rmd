...
range and median model error was 6.086 cm. In this case daily percent bias
estimates (PBIAS) would be helpful to consider error relative to observed daily
...
The Connectivity, Inundation, and Drawdown probabilities all agree, suggesting
that there are not wild swings within months or between simulation years (Figure 
\@ref(fig:probabilities)).
...
for relative RMedSE than for RMedSE.
